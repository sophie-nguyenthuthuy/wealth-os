...
Wealth OS operates across **four** legal jurisdictions on day one: Vietnam (home country, payouts) plus Japan, South Korea, and Taiwan (host countries, fund sources). Compliance is *not* a milestone — it's a precondition for revenue.
...
Day-one position: ride on a licensed partner (e.g., SBI Remit Vietnam, Seven Bank International Money Transfer). Wealth OS is the *interface*, the partner is the *licensed entity*. The partnership contract defines who is on the regulator's hook for which obligation.
